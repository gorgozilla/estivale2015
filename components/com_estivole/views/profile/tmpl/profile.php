<a href="<?php echo JRoute::_('index.php?option=com_estivole&view=profile&layout=list'); ?>" class="btn pull-right"><i class="icon icon-chevron-left"></i> <?php echo JText::_('COM_ESTIVOLE_BACK'); ?></a>
...
<div class="tabbable">
  <ul class="nav nav-tabs">
    <li class="active"><a href="#libraryTab" data-toggle="tab"><?php echo JText::_('COM_ESTIVOLE_LIBRARY'); ?></a></li>
    <li><a href="#wishlistTab" data-toggle="tab"><?php echo JText::_('COM_ESTIVOLE_WISHLIST'); ?></a></li>
    <li><a href="#waitlistTab" data-toggle="tab"><?php echo JText::_('COM_ESTIVOLE_WAITLIST'); ?></a></li>
  </ul>
  <div class="tab-content">
    <div class="tab-pane active" id="libraryTab">
      <?php if($this->profile->isMine) { ?>
        <a href="#newBookModal" role="button" data-toggle="modal" class="btn pull-right"><i class="icon icon-pencil-2"></i> <?php echo JText::_('COM_ESTIVOLE_ADD_BOOK'); ?></a>
      <?php } ?>
      <h2><?php echo JText::_('COM_ESTIVOLE_LIBRARY'); ?></h2>
      <?php echo $this->_libraryView->render(); ?>
    </div>
    <div class="tab-pane" id="wishlistTab">
      <h2><?php echo JText::_('COM_ESTIVOLE_WISHLIST'); ?></h2>
      <?php echo $this->_wishlistView->render(); ?>
    </div>
    <div class="tab-pane" id="waitlistTab">
      <h2><?php echo JText::_('COM_ESTIVOLE_WAITLIST'); ?></h2>
