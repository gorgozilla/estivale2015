<div id="returnBookModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="returnBookModalLabel" aria-hidden="true">
  <div class="modal-header">
    ...
    <h3 id="myModalLabel"><?php echo JText::_('COM_ESTIVOLE_RETURN'); ?></h3>
  </div>
  <div class="modal-body">
	<div class="row-fluid">
		<form id="returnForm">
			<div class="alert alert-info">
        <?php echo JText::_('COM_ESTIVOLE_RETURN_DESC'); ?>
      </div>
  ...
  <div class="modal-footer">
    ...
    <button class="btn btn-primary" onclick="returnBook();"><?php echo JText::_('COM_ESTIVOLE_RETURN'); ?></button>
  </div>
</div>