<div id="lendBookModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="lendBookModalLabel" aria-hidden="true">
  <div class="modal-header">
    ...
    <h3 id="myModalLabel"><?php echo JText::_('COM_ESTIVOLE_LEND_BOOK'); ?></h3>
  </div>
  <div class="modal-body">
	<div class="row-fluid">
		<form id="lendForm">
			<div class="alert alert-info">
        <?php echo JText::_('COM_ESTIVOLE_LEND_BOOK_TO'); ?> <span id="borrower_name"></span>
      </div>
  ...
  <div class="modal-footer">
    ...
    <button class="btn btn-primary" onclick="lendBook();"><?php echo JText::_('COM_ESTIVOLE_LEND'); ?></button>
  </div>
</div>