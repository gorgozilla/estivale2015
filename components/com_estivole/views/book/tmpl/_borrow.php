<div id="borrowBookModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="newBookModalLabel" aria-hidden="true">
  <div class="modal-header">
    ...
    <h3 id="myModalLabel"><?php echo JText::_('COM_ESTIVOLE_BORROW_BOOK'); ?></h3>
  </div>
  <div class="modal-body">
	<div class="row-fluid">
		<form id="borrowForm">
			<div class="alert alert-info">
        <?php echo JText::_('COM_ESTIVOLE_REQUEST_BOOK'); ?>
      </div>
  ...
  <div class="modal-footer">
    ...
    <button class="btn btn-primary" onclick="borrowBook();"><?php echo JText::_('COM_ESTIVOLE_BORROW'); ?></button>
  </div>
</div>