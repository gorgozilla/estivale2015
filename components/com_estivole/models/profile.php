...
class EstivoleModelsProfile extends EstivoleModelsDefault
{
  ...
  protected function _buildQuery()
  {
    ...
    $query->leftjoin("#__estivole_books as b on b.user_id = u.id");

    $query->select("COUNT(DISTINCT(r.review_id)) as totalReviews");
    $query->leftjoin("#__estivole_reviews as r on r.user_id = u.id");
