CREATE TABLE IF NOT EXISTS `#__estivole_books` (
...
CREATE TABLE IF NOT EXISTS `#__estivole_libraries` (
...
CREATE TABLE IF NOT EXISTS `#__estivole_waitlists` (
...
CREATE TABLE IF NOT EXISTS `#__estivole_wishlists` (
...
CREATE TABLE IF NOT EXISTS `#__estivole_reviews` (
